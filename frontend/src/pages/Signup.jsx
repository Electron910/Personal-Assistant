  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-500 to-green-700 flex-col items-center justify-center p-12 relative overflow-hidden animate-fade-in">
        {/* Decorative circles */}
        <div className="absolute top-[-80px] right-[-80px] w-64 h-64 rounded-full bg-white/10 animate-fade-in delay-200" />
        <div className="absolute bottom-[-60px] left-[-60px] w-80 h-80 rounded-full bg-white/10 animate-fade-in delay-300" />
        <div className="absolute top-1/2 left-[-40px] w-40 h-40 rounded-full bg-emerald-400/30 animate-fade-in delay-400" />
        ...
        <div className="relative z-10 text-center">
          ...
          <h1 className="animate-fade-slide-up delay-100 text-4xl font-bold text-white mb-4">Start for free</h1>
          ...
          <ul className="animate-fade-slide-up delay-300 mt-8 space-y-3 text-left">
